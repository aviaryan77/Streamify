...
const PageLayout: FC<PageLayoutProps> = ({ children }) => {
  return (
    <div className='grid grid-cols-12 gap-6 px-5 py-14 min-h-lvh sm:px-20 md:px-32 lg:px-12 xl:px-20 2xl:px-48 bg-[url(/images/background.jpg)] bg-cover bg-center'>
